...
class SlaveServerClass
{
	...
	public:
		...
		void Set(bool enable, const char* nick, const char* serial, unsigned short port, const char* settings_file, int bandwidth, const
		         char* password);
...
class SlaveMasterClass
{
	public:
		...
		void Add_Slave(bool enable, const char* nick, const char* serial, unsigned short port, const char* settings_file, int bandwidth, const
		               char* password);
