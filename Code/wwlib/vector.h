...
class DynamicVectorClass : public VectorClass<T>
{
	public:
		...
		bool Delete_Value(T const & object);
...
/***********************************************************************************************
 * DynamicVectorClass<T>::Delete_Value -- Remove the specified object from the vector.               *
 *                                                                                             *
 ...
 *=============================================================================================*/
template<class T>
bool DynamicVectorClass<T>::Delete_Value(T const & object)
{
	int id = ID(object);
	if (id != -1) {
		return(Delete(id));
